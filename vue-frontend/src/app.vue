  ...
  <div class="full-section" id="chaos">
    <div class="full-section" v-if="passwordRight">
      ...
      <div class="nav">
        ...
        <div
          class="move-bar"
          :style="{ left: (2 * this.$route.meta.index - 1) * 12.5 + '%' }"
        ></div>
      </div>
...
export default {
  ...
  methods: {
    ...
    touchend(e) {
      ...
      if (
        Math.abs(this.touchEndPoint.screenX - this.touchStartPoint.screenX) >
          10 &&
        Math.abs(this.touchEndPoint.screenY - this.touchStartPoint.screenY) < 20
      ) {
        this.switchRouter(
          this.touchEndPoint.screenX - this.touchStartPoint.screenX,
